...
ncores = 8 # Adjust this accordingly
...
arrow_dir = file.path(cur_dir, "./example/ArrowFiles")
bindepth_dir = file.path(cur_dir, "./example/binned_depth")
scatools_dir = file.path(cur_dir, "./example/scatools_analysis")
...
```{r, message=FALSE}
cnaHeatmap(sce = sce, assay_name = "counts", log2 = TRUE, scale = "both", legend_name = "Log Normalized Counts")
```
