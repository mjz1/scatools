...
We start by loading `scatools`, as well as the filepath to an example `fragments.bed.gz` file containing fragments from 100 normal mammary cells. This bed file was generated using the `reformatFragmentFiles()` function from the `ArchR` package.
...
To generate your own `bins` object, a helper function is provided. Please note that running this function requires installation of 
...
We load blacklist regions for our genome
